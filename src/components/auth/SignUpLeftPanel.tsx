export default function SignUpLeftPanel() {
  return (
    <div className="hidden lg:flex flex-col relative overflow-hidden bg-[#0f0f0f] p-11 w-full min-h-screen">
      ...
      <div className="relative flex-1 z-10 m-[32px_-8px]">
        <div className="absolute bg-[#161616] border border-[#252525] rounded-[18px] fa w-[272px] p-[18px] top-[24px] left-[12px]">
        ...
        <div className="absolute bg-white border border-[#eee] rounded-[18px] shadow-[0_24px_64px_rgba(0,0,0,0.22)] fb w-[210px] p-[15px] top-0 right-[4px]">
        ...
        <div className="absolute bg-[#161616] border border-[#252525] rounded-[18px] fc w-[186px] p-[15px] bottom-[10px] left-[8px]">
          ...
          <div className="text-white font-syne text-[21px] font-extrabold mb-0.5 tracking-[-0.02em]">
            12 Posts
          </div>
        ...
        <div className="absolute bottom-[44px] right-[6px] bg-[#161616] border border-[#252525] rounded-full p-[7px_13px] flex items-center gap-[7px] fb">
      ...
      <div className="relative z-10">
        <div className="inline-flex items-center gap-[6px] border border-[#2a2a2a] rounded-full p-[5px_12px] mb-[18px]">
          ...
          <span className="text-[#888] text-[11px] font-semibold tracking-[0.08em] font-syne">
            4,000+ creators trust PostFlow
          </span>
        </div>
